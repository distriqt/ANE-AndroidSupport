...
package
{
	import com.distriqt.extension.transition.Transition;
	...
	public class TestTransition extends Sprite
	{
		...
		private function init( ):void
		{
			try
			{
				message( "Transition Supported: " + Transition.isSupported );
				message( "Transition Version:   " + Transition.service.version );
