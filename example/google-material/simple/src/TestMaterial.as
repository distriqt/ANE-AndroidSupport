...
package
{
	...
	/**	
	 * Sample application for using the Material Native Extension
	 */
	public class TestMaterial extends Sprite
	{
		...
		private function init( ):void
		{
			try
			{
				message( "Material Supported: " + Material.isSupported );
				message( "Material Version:   " + Material.service.version );
