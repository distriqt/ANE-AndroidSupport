...
package
{
	...
	/**	
	 * Sample application for using the DataTransport Native Extension
	 */
	public class TestDataTransport extends Sprite
	{
		 ...
		 * Class constructor
		 */
		public function TestDataTransport()
		{
			super();
			create();
			init();
		...
		private function init( ):void
		{
			try
			{
				message( "DataTransport Supported: " + DataTransport.isSupported );
				message( "DataTransport Version:   " + DataTransport.service.version );
